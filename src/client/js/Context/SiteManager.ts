...
export class SiteManager {
    private static _instance: SiteManager = null;
    private _isInit: boolean;
    private _siteDiv: any;
    private _siteStack: any[];
    private _titleTranslationCallbackId: any;
    private _appEndedListener: any;
