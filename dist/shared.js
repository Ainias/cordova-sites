...
__webpack_require__.d(__webpack_exports__, {
  "encodeUrl": () => (/* reexport */ encodeUrl),
  "redirectFromInitialProps": () => (/* reexport */ redirectFromInitialProps)
});

;// CONCATENATED MODULE: ./src/shared/helper/encodeUrl.ts
...
;// CONCATENATED MODULE: ./src/shared/helper/redirectFromInitialProps.ts
...
function redirectFromInitialProps(newLocation, res) {
  ...
  return router_default().replace(newLocation);
}
