...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".OatLIh_8idgYyITdi8Eq{height:100%;width:100%;display:flex;flex-direction:column}.D2V5nRmaplVapiAC7Fot{flex:1;position:relative;width:100%;overflow:hidden}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"sites": "OatLIh_8idgYyITdi8Eq",
	"siteContainer": "D2V5nRmaplVapiAC7Fot"
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(___CSS_LOADER_API_NO_SOURCEMAP_IMPORT___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".e0cZemNAF1r8OodAVo01{width:100%;flex:none;padding:0;overflow:visible;z-index:1}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"footer": "e0cZemNAF1r8OodAVo01"
};
module.exports = ___CSS_LOADER_EXPORT___;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".qXEsCywBVWu4EIgj2dQQ{display:inline-block;width:1.31rem;height:1rem;background-repeat:no-repeat;background-size:contain}.flat-design .qXEsCywBVWu4EIgj2dQQ{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ")}.material-design .qXEsCywBVWu4EIgj2dQQ{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"backButtonImg": "qXEsCywBVWu4EIgj2dQQ"
};
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(___CSS_LOADER_API_NO_SOURCEMAP_IMPORT___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".xzV8d2Se1qBMUXR10avg{width:100%}.xzV8d2Se1qBMUXR10avg img{object-fit:cover;height:100%;width:100%}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"topBarImage": "xzV8d2Se1qBMUXR10avg"
};
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(__webpack_exports__, {
  "BackButton": () => (/* reexport */ BackButtonMemo),
...
;// CONCATENATED MODULE: external "js-helper"
const external_js_helper_namespaceObject = require("js-helper");
...
class ClassSiteAnimation {
  ...
  animateSiteEnd(fromSite) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield external_js_helper_namespaceObject.Helper.delay(this.duration);
...
;// CONCATENATED MODULE: external "react-bootstrap-mobile"
const external_react_bootstrap_mobile_namespaceObject = require("react-bootstrap-mobile");
...
function BackButton({}) {
  ...
  if (sites === null || sites === void 0 ? void 0 : sites.canGoBack()) {
    return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.TopBarButton, {
      onClick: goBack
    }, /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.InlineBlock, {
...
const BackButtonMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(BackButton, (backButton_default()));
...
const TopBar = /*#__PURE__*/external_react_namespaceObject.memo(function TopBar({
  ...
  const realNumberButtons = (_a = (0,external_react_bootstrap_mobile_namespaceObject.useBreakpointSelect)([numberButtonsXS, numberButtonsSM, numberButtonsMD, numberButtonsXL, numberButtonsLG, numberButtonsXXL])) !== null && _a !== void 0 ? _a : numberButtons;
  ...
  return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.TopBar, {
    title: title,
...
class SiteContainer extends external_react_namespaceObject.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.Block, {
      ref: this.container,
...
const SiteContainerMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(SiteContainer, (siteContainer_default()));
...
function Footer({
  ...
  }, /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.TabBar, {
    buttons: buttons,
    activeTab: activeTab,
...
const FooterMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(Footer, (footer_default()));
...
class SitesInner extends external_react_namespaceObject.PureComponent {
  constructor(props) {
    ...
    this.onPopState = e => {
      ...
      if ((_a = e.state) === null || _a === void 0 ? void 0 : _a.obsolete) {
        window.history.go(-1);
    ...
    this.sites.set(this.currentSiteId, Object.assign(Object.assign({}, props.currentSite), {
      ...
      containerRefPromise: new external_js_helper_namespaceObject.PromiseWithHandlers(),
      footerOptions: {},
      finished: false
  ...
  render() {
    ...
    })), /*#__PURE__*/external_react_namespaceObject.createElement(FooterMemo, Sites_extends({}, defaultFooterOptions, footerOptions)), /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.ToastContainer, null, toasts.map(toast => {
      return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.Toast, Sites_extends({}, toast, {
        key: toast.id,
  ...
  getActiveSites() {
    return Array.from(this.sites.values()).filter(s => !s.finished);
  }
...
const SitesWithRouter = (0,router_namespaceObject.withRouter)((0,external_react_bootstrap_mobile_namespaceObject.withMemo)(SitesInner, (sites_default())));
...
function FinishSiteLink({
  ...
  return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.Clickable, {
    style: style,
...
const FinishSiteLinkMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(FinishSiteLink);
...
const SiteLink = function SiteLink({
  ...
  const isInViewport = (0,external_react_bootstrap_mobile_namespaceObject.useInViewport)(linkRef);
  ...
  return /*#__PURE__*/external_react_default().createElement(external_react_bootstrap_mobile_namespaceObject.Clickable, {
    interactable: true,
    style: style,
    onClick: onClickHandler,
    href: href,
...
const SiteLinkMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(SiteLink, undefined, 'text');
...
function TopBarImage({
  ...
  // Variables
  // States
  const [transparentTopBar, setTransparentTopBar] = (0,external_react_namespaceObject.useState)(true); // Refs
  // Callbacks

  const onInViewportChange = (0,external_react_namespaceObject.useCallback)(inViewport => {
    setTransparentTopBar(inViewport);
  }, [setTransparentTopBar]); // Effects

  useTopBar({
    transparent: transparentTopBar,
    drawBehind: true
  }, [transparentTopBar]); // Other
  // Render Functions

  return /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.InViewport, {
    onInViewportChange: onInViewportChange,
    threshold: 0.1,
    className: (topBarImage_default()).topBarImage
  }, /*#__PURE__*/external_react_namespaceObject.createElement(external_react_bootstrap_mobile_namespaceObject.Image, {
    style: maxHeight ? {
      maxHeight
    } : undefined,
    src: image
...
const TopBarImageMemo = (0,external_react_bootstrap_mobile_namespaceObject.withMemo)(TopBarImage, (topBarImage_default()));
