/*!
 * 
 *   @ainias42/cordova-sites v0.8.10
...
;// CONCATENATED MODULE: external "hoist-non-react-statics"
const external_hoist_non_react_statics_namespaceObject = require("hoist-non-react-statics");
var external_hoist_non_react_statics_default = /*#__PURE__*/__webpack_require__.n(external_hoist_non_react_statics_namespaceObject);
...
class SitesInner extends external_react_namespaceObject.PureComponent {
  ...
  constructor(props) {
    ...
    this.dialogContainerRef = /*#__PURE__*/external_react_namespaceObject.createRef();
  ...
  render() {
    ...
    const content = /*#__PURE__*/external_react_namespaceObject.createElement(SitesContext.Provider, {
      value: this
    }, /*#__PURE__*/external_react_namespaceObject.createElement(react_bootstrap_mobile_namespaceObject.DialogContainer, {
      ref: this.dialogContainerRef
    }, /*#__PURE__*/external_react_namespaceObject.createElement(react_bootstrap_mobile_namespaceObject.Flex, {
  ...
  showDialog(dialog, props) {
    var _a;
    return (_a = this.dialogContainerRef.current) === null || _a === void 0 ? void 0 : _a.showDialog(dialog, props);
  }
...
external_hoist_non_react_statics_default()(SitesWithRouter, SitesInner);
